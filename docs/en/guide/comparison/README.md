...
| **Multi-language Platform** | JVM | JVM | JVM | Go Core | Python | TypeScript |
...
- **JustDB (Low)**: Intuitive YAML format, Fluent API matches Java development habits
...
3. **Version Control Friendly**: YAML format produces clear diffs, more effective Code Review
...
| **Cross-Language Teams** | Atlas / JustDB | Multi-language support, but Atlas has high learning cost |

## Multi-language Platform Support

| Tool | Core Language | Cross-Platform Support | Notes |
|:---|:---:|:---:|:---|
| **JustDB** | Java | ✅ Full JVM Platform | Kotlin / Scala / Groovy |
...
- **Java/Kotlin Projects**: JustDB / Flyway / Liquibase
- **Python Projects**: SQLAlchemy
- **Node.js Projects**: Prisma / Atlas
- **Multi-Language Microservices**: JustDB (for JVM services) + Atlas (for non-JVM services)
...
| **Python Web App** | SQLAlchemy | Python ecosystem, ORM integration |
| **Node.js App** | Prisma | TypeScript first |
| **Microservices** | JustDB / Atlas | Lightweight, independent deployment |
| **Enterprise App** | Liquibase / Atlas Cloud | Mature stability, enterprise features |
...
| **Enterprise Features** | Liquibase / Atlas Cloud / Flyway Teams |
| **Precise SQL Control** | Flyway |
| **Rapid Iteration** | JustDB |
| **GitOps Workflow** | Atlas |
...
4. **AI Integration**: Natural language database operations
5. **JDBC Driver**: Unique in-memory database driver
6. **Documentation**: Schema as documentation philosophy
7. **Low Learning Cost**: Intuitive YAML format, comprehensive documentation
8. **Data Autonomy**: Local AI, data stays within enterprise

### Selection Recommendations

::: tip Choose JustDB if
- You use Java or JVM languages (Kotlin/Scala/Groovy)
- You need rapid database schema iteration
- You value database documentation
- You want consistency across multiple databases
- You want natural language database operations
- You need JDBC driver for offline development
- You care about data autonomy in the AI era
- You need flexible template system for custom SQL
- You prefer schema files as code, easy for Code Review
:::

::: tip Choose other tools if
- **Python Ecosystem**: Choose SQLAlchemy for deeper type hints and ORM integration
- **Node.js/TypeScript**: Choose Prisma for modern type generation and query API
- **Non-JVM Languages**: Choose language-specific tools (Go, Ruby, PHP, etc.)
- **Existing Team Habits**: Team already familiar with Flyway/Liquibase, high migration cost
- **Specific Platform Needs**: Need native Terraform integration (choose Atlas)
- **Pure Imperative Preference**: Team more comfortable writing and managing SQL script files
:::
